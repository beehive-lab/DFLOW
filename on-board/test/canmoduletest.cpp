...
void process_set_helper(std::vector<Pipes>can_pipes_vector,std::shared_future<void> futureObj)
{
...
TEST_F(ModuleTest, TestListener) {
    ...
    std::thread test_can_module_thread(process_set_helper,can_pipes_vector,futureObj);
